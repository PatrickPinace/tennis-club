...
urlpatterns = [
    ...
    path('courts/series/<uuid:series_uuid>/edit/', views.EditSeriesView.as_view(), name='edit-series'),
    path('courts/reservations/<int:pk>/edit/', views.EditReservationView.as_view(), name='edit-reservation'),
